...
TargetMachineOptions :: TargetMachineOptionsRef
OpaqueTargetMachine :: struct {}
TargetMachineRef :: ^OpaqueTargetMachine
TargetMachine :: TargetMachineRef
OpaqueTarget :: struct {}
TargetRef :: ^OpaqueTarget
Target :: TargetRef

CodeGenOptLevel :: enum LLVM_C_Enum {
    None       = 0,
    Less       = 1,
    Default    = 2,
    Aggressive = 3,
...
CodeGenFileType :: enum LLVM_C_Enum {
    AssemblyFile = 0,
    ObjectFile   = 1,
}

GlobalISelAbortMode :: enum LLVM_C_Enum {
    Enable          = 0,
    Disable         = 1,
    DisableWithDiag = 2,
}
