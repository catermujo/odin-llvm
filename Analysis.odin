...
* @{
*/
VerifierFailureAction :: enum LLVM_C_Enum {
    AbortProcess = 0, /* verifier will print to stderr and abort() */
    PrintMessage = 1, /* verifier will print to stderr and return 1 */
    ReturnStatus = 2, /* verifier will just return 1 */
}
