...
DIFlag :: enum LLVM_C_Enum {
    ...
    RValueReference     = 14,
    Reserved            = 15,
    SingleInheritance   = 16,
    MultipleInheritance = 17,
    IntroducedVirtual   = 18,
    BitField            = 19,
    NoReturn            = 20,
    TypePassByValue     = 22,
    TypePassByReference = 23,
    EnumClass           = 24,
    Thunk               = 25,
    NonTrivial          = 26,
    BigEndian           = 27,
...
DIFlags :: bit_set[DIFlag;LLVM_C_Enum]

DIFlagZero :: DIFlags{}
DIFlagPublic :: DIFlags{.Private, .Protected}
DIFlagVirtualInheritance :: DIFlags{.SingleInheritance, .MultipleInheritance}
DIFlagFixedEnum :: DIFlags{.EnumClass} // Deprecated.
DIFlagIndirectVirtualBase :: DIFlags{.FwdDecl, .Virtual}
DIFlagAccessibility :: DIFlags{.Private, .Protected}
DIFlagPtrToMemberRep :: DIFlags{.SingleInheritance, .MultipleInheritance}

#assert(size_of(DIFlags) == 4)

/**
* Source languages known by DWARF.
*/
DWARFSourceLanguage :: enum LLVM_C_Enum {
    C89                 = 0,
    C                   = 1,
    Ada83               = 2,
    C_plus_plus         = 3,
...
*/
DWARFEmissionKind :: enum LLVM_C_Enum {
    None           = 0,
    Full           = 1,
    LineTablesOnly = 2,
}
...
*/
DWARFMacinfoRecordType :: enum LLVM_C_Enum {
    Define    = 1,
    Macro     = 2,
    StartFile = 3,
    EndFile   = 4,
...
foreign lib {
	...
	* \param Flags           E.g.: \c DIFlags{.LValueReference}. These flags are
	...
	* \param Flags           E.g.: \c DIFlags{.LValueReference}.
