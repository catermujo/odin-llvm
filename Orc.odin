...
*/
JITSymbolGenericFlag :: enum LLVM_C_Enum {
    Exported                       = 0,
    Weak                           = 1,
    Callable                       = 2,
    MaterializationSideEffectsOnly = 3,
}
JITSymbolGenericFlags :: bit_set[JITSymbolGenericFlag;LLVM_C_Enum]
JITSymbolGenericFlagsNone :: JITSymbolGenericFlags{}
...
JITSymbolFlags :: struct {
    Generic: bit_set[JITSymbolGenericFlag;u8],
    Target:  JITSymbolTargetFlags,
}

#assert(size_of(JITSymbolGenericFlags) == 4)
#assert(size_of(JITSymbolFlags) == 2)
#assert(align_of(JITSymbolFlags) == 1)
#assert(offset_of(JITSymbolFlags, Generic) == 0)
#assert(offset_of(JITSymbolFlags, Target) == 1)
...
OrcExecutionSession :: OrcExecutionSessionRef
...
OrcSymbolStringPool :: OrcSymbolStringPoolRef
...
OrcSymbolStringPoolEntry :: OrcSymbolStringPoolEntryRef
...
*/
OrcLookupKind :: enum LLVM_C_Enum {
    Static = 0,
    DLSym  = 1,
}
...
*/
OrcJITDylibLookupFlags :: enum LLVM_C_Enum {
...
*/
OrcSymbolLookupFlags :: enum LLVM_C_Enum {
    RequiredSymbol         = 0,
...
OrcMaterializationUnit :: OrcMaterializationUnitRef
...
OrcMaterializationResponsibility :: OrcMaterializationResponsibilityRef
...
OrcResourceTracker :: OrcResourceTrackerRef
...
OrcDefinitionGenerator :: OrcDefinitionGeneratorRef
...
OrcLookupState :: OrcLookupStateRef
...
OrcThreadSafeContext :: OrcThreadSafeContextRef
...
OrcThreadSafeModule :: OrcThreadSafeModuleRef
...
OrcJITTargetMachineBuilder :: OrcJITTargetMachineBuilderRef
...
OrcObjectLayer :: OrcObjectLayerRef
...
OrcObjectLinkingLayer :: OrcObjectLinkingLayerRef
...
OrcIRTransformLayer :: OrcIRTransformLayerRef
...
OrcObjectTransformLayer :: OrcObjectTransformLayerRef
...
OrcIndirectStubsManager :: OrcIndirectStubsManagerRef
...
OrcLazyCallThroughManager :: OrcLazyCallThroughManagerRef
...
OrcDumpObjects :: OrcDumpObjectsRef
...
foreign lib {
	...
	*
	* The SearchOrder argument contains a list of (JITDylibs, JITDylibLookupFlags)
	...
	* list with the JITSymbolGenericFlags{.MaterializationSideEffectsOnly} flag
