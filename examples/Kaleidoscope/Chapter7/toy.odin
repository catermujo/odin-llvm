...
OPTIMIZATION_PASSES :: "mem2reg,instcombine,reassociate,gvn,simplifycfg"
...
handle_definition :: proc() {
    ...
    old_precedence := 0
    if is_binary {
        old_precedence = binop_precedence[prototype_operator(function_ast.proto)]
    }
    ...
    if submit_definition() {
        ...
        binop_precedence[prototype_operator(function_ast.proto)] = old_precedence
    }
}
