...
DLLStorageClass :: enum LLVM_C_Enum {
...
RealPredicate :: enum LLVM_C_Enum {
...
ThreadLocalMode :: enum LLVM_C_Enum {
    NotThreadLocal         = 0,
...
AtomicOrdering :: enum LLVM_C_Enum {
...
AtomicRMWBinOp :: enum LLVM_C_Enum {
...
DiagnosticSeverity :: enum LLVM_C_Enum {
    Error   = 0,
    Warning = 1,
    Remark  = 2,
    Note    = 3,
...
InlineAsmDialect :: enum LLVM_C_Enum {
    ATT   = 0,
    Intel = 1,
}

ModuleFlagBehavior :: enum LLVM_C_Enum {
    /**
...
FastMathFlags :: bit_set[FastMathFlag;u32]

LLVMFastMathAllowReassoc :: FastMathFlags{.AllowReassoc}
LLVMFastMathNoNaNs :: FastMathFlags{.NoNaNs}
LLVMFastMathNoInfs :: FastMathFlags{.NoInfs}
LLVMFastMathNoSignedZeros :: FastMathFlags{.NoSignedZeros}
LLVMFastMathAllowReciprocal :: FastMathFlags{.AllowReciprocal}
LLVMFastMathAllowContract :: FastMathFlags{.AllowContract}
LLVMFastMathApproxFunc :: FastMathFlags{.ApproxFunc}
LLVMFastMathNone :: FastMathFlags{}
LLVMFastMathAll :: FastMathFlags {
    .AllowReassoc,
    .NoNaNs,
    .NoInfs,
    .NoSignedZeros,
...
*/
GEPNoWrapFlag :: enum u32 {
    InBounds = 0,
    NUSW     = 1,
    NUW      = 2,
}
GEPNoWrapFlags :: bit_set[GEPNoWrapFlag;u32]

LLVMGEPFlagInBounds :: GEPNoWrapFlags{.InBounds}
LLVMGEPFlagNUSW :: GEPNoWrapFlags{.NUSW}
LLVMGEPFlagNUW :: GEPNoWrapFlags{.NUW}

#assert(size_of(FastMathFlags) == 4)
#assert(size_of(GEPNoWrapFlags) == 4)

DbgRecordKind :: enum LLVM_C_Enum {
    Label   = 0,
    Declare = 1,
    Value   = 2,
    Assign  = 3,
...
foreign lib {
	...
	*/
    ...
    /**
	* Return the corresponding value if Key appears in the module flags;
